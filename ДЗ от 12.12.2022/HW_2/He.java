...
public class He {
    ...
    /*
     * Перед тем, как заглянуть в шкаф (покопаться в нем) или взять из него что-то,
     * необходимо получить разрешение жены - обеспечить открытие шкафа. Даже жене
     * как классу, производному от мужа, нужно переспросить себя, перед тем как
     * выполнить действия в Husband
     */
